...
CREATE TABLE IF NOT EXISTS `mercadofacil`.`comerciante` (
  ...
  `tipoPerfil` VARCHAR(45) NOT NULL COMMENT '',
  `idEndereco` INT(11) NOT NULL COMMENT '',
  `nfEmpresa` VARCHAR(45) NOT NULL COMMENT '',
  `rsEmpresa` VARCHAR(45) NOT NULL COMMENT '',
...
SHOW WARNINGS;
CREATE USER 'administrador' IDENTIFIED BY 'mercadofacil';

GRANT ALL ON `mercadofacil`.* TO 'administrador';
SHOW WARNINGS;

...
<body>
	...
	<div class="header-in">
		<div class="container">
			<div class="logo">
				<h1><a href="supermercadounico/supermercadounico_home.jsp">Supermercado Único</a></h1>
			</div>
			<div class="header-top">
				<div class="header-top-in">
					<ul class="header-grid">
						<li  ><a href="supermercadounico/supermercadounico_loginpessoafisica.jsp">  Entrar </a> </li>		
					</ul>
			...
			<div class="header-bottom">
				<div class="top-nav">
					...
					<ul>
						<li  ><a href="supermercadounico/supermercadounico_home.jsp" >Home  </a><label>- </label> </li>
					</ul>
					<!--script-->
				<script>
		...
		<form action="cadastrar" method="post" class="form-group col-md-10 col-sm-offset-1">
			...
			<div class="row">
 				<div class="form-group col-md-4">
  					 ...
  					 <input type="text" class="form-control" id="campo1" name="nomeCompleto" required>
				</div>
 
 				<div class="form-group col-md-4">
   					<label for="campo2">E-mail</label>
  					<input type="email" class="form-control" id="campo2" name="email" placeholder="fulano@servidor.com" required>
 				</div>
 				
 				<div class="form-group col-md-4">
   					<label for="campo3">Repita o e-mail</label>
   					<input type="email" class="form-control" id="campo3" placeholder="fulano@servidor.com" required>
 				</div>
 
 				<div class="form-group col-md-4">
   					<label for="campo4">Telefone</label>
   					<input type="tel" class="form-control" id="campo4" name="telefone" placeholder="(00) 0000-0000" required>
 				</div>

				<div class="form-group col-md-4">
   					<label for="campo5">Celular</label>
   					<input type="text" class="form-control" id="campo5" name="celular" placeholder="(00) 0000-0000" required>
 				</div>
 				
 				<div class="form-group col-md-4">
   					<label for="campo6">CPF</label>
   					<input type="text" class="form-control" id="campo6" name="cpf" placeholder="000.000.000-00" required>
 				</div>
 				
 				<div class="form-group col-md-4">
   					<label for="campo7">Senha</label>
   					<input type="password" class="form-control" id="campo7" name="senha" required>
 				</div>
 				
 				<div class="form-group col-md-4">
   					<label for="campo8">Repita a senha</label>
   					<input type="password" class="form-control" id="campo8" required>
 				</div>
			</div>
			...
			<div class="row">
				<div class="form-group col-md-4">
  					 ...
  					 <input type="text" class="form-control" id="campo1" name="cep" placeholder="00000-000" required>
				</div>
 
 				<div class="form-group col-md-4">
   					<label for="campo2">Cidade</label>
  					<input type="text" class="form-control" id="campo2" name="cidade" required>
 				</div>
 
 				<div class="form-group col-md-4">
   					<label for="campo4">Estado</label>
   					<input type="text" class="form-control" id="campo4" name="estado" required>
 				</div>

				<div class="form-group col-md-4">
   					<label for="campo5">Bairro</label>
   					<input type="text" class="form-control" id="campo5" name="bairro" required>
 				</div>
 				
 				<div class="form-group col-md-4">
   					<label for="campo6">Logradouro</label>
   					<input type="text" class="form-control" id="campo6" name="logradouro" required>
 				</div>
 				...
 				<div class="form-group col-md-4">
   					...
   					<input type="text" class="form-control" id="campo8" name="numero" required>
 				</div>
			</div>

...
<!-- Bootstrap Core CSS -->
<link
	href="http://localhost:8080/mercadofacil/admin/bower_components/bootstrap/dist/css/bootstrap.min.css"
	rel="stylesheet">

<!-- MetisMenu CSS -->
<link
	href="http://localhost:8080/mercadofacil/admin/bower_components/metisMenu/dist/metisMenu.min.css"
	rel="stylesheet">

<!-- Custom CSS -->
<link
	href="http://localhost:8080/mercadofacil/admin/dist/css/sb-admin-2.css"
	rel="stylesheet">

<!-- Custom Fonts -->
<link
	href="http://localhost:8080/mercadofacil/admin/bower_components/font-awesome/css/font-awesome.min.css"
...
<body onload="t" id="wrapper">
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="admin/pages/painelAdmin.jsp"><i
							class="fa fa-dashboard fa-fw" class="active"></i> Dashboard</a></li>
					<li><a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>
							Controle Financeiro<span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a href="#"> Gráficos</a></li>
							<li><a href="#"> Tabelas</a></li>
						</ul> <!-- /.nav-second-level --></li>
					<li><a href="consultarproduto?categoria=Todos"><i
							class="fa fa-table fa-fw"></i> Listar</a></li>
					<li><a href="admin/pages/cadastroProdutos.jsp"><i
							class="fa fa-edit fa-fw"></i> Cadastro de Produtos</a></li>
					<li><a href="#"><i class="fa fa-wrench fa-fw"></i>
							Configurações<span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
	...
	<!-- jQuery -->
	<script
		src="http://localhost:8080/mercadofacil/admin/bower_components/jquery/dist/jquery.min.js"></script>

	<!-- Bootstrap Core JavaScript -->
	<script
		src="http://localhost:8080/mercadofacil/admin/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>

	<!-- Metis Menu Plugin JavaScript -->
	<script
		src="http://localhost:8080/mercadofacil/admin/bower_components/metisMenu/dist/metisMenu.min.js"></script>

	<!-- Custom Theme JavaScript -->
	<script
		src="http://localhost:8080/mercadofacil/admin/dist/js/sb-admin-2.js"></script>

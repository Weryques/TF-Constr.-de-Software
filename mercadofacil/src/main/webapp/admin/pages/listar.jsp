	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand active" href="painelAdmin.jsp">Mercado
					Fácil / Admin v1.0</a>
			</div>
			<!-- /.navbar-header -->
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a href="listar.jsp"><i class="fa fa-table fa-fw"></i>
								Listar</a></li>
						<li><a href="cadastroProdutos.jsp"><i
					...
					<div class="col-lg-12">
						...
						<form name="Categoria" action="../../consultarproduto">
							<div class="form-group col-md-12">
								<label for="sel1">Categoria:</label> <select
									class="form-control" name="opcao">

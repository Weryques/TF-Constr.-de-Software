...
<!-- Bootstrap Core CSS -->
<link href="http://localhost:8080/mercadofacil/admin/bower_components/bootstrap/dist/css/bootstrap.min.css"
	rel="stylesheet">

<!-- MetisMenu CSS -->
<link href="http://localhost:8080/mercadofacil/admin/bower_components/metisMenu/dist/metisMenu.min.css"
	rel="stylesheet">
...
<!-- Custom Fonts -->
<link href="http://localhost:8080/mercadofacil/admin/bower_components/font-awesome/css/font-awesome.min.css"
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="painelAdmin.jsp">Mercado Fácil /
					Admin v1.0</a>
			</div>
			<!-- /.navbar-header -->
					...
					<div class="col-md-12">
						...
						<form role="form" name="CadastroProdutos"
							...
							<div class="form-group col-md-2">
								...
								<label for="PrecoDeCompraProduto"> Preço de Compra </label> <input
							...
							<div class="form-group col-md-3">
								<label for="NomeProduto"> CNPJ/CPF Comerciante </label> <input
									type="text" class="form-control" name="cnpjAnunciante">
							</div>
							<div class="form-group col-md-3">
								<label for="NomeProduto"> CNPJ/CPF Anunciante </label> <input
							...
							<div class="form-group col-md-6">
								<button type="submit"
									class="btn btn-outline btn-primary btn-lg ">Salvar</button>
								<button type="button"

 ...
 * Generated at: 2016-02-15 19:35:16 UTC
...
public final class supermercadounico_005fhome_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(session.getAttribute("consumidor") != null){
						...
						out.prin("<li><a href="+"#"+" class="+"glyphicon glyphicon-user"+"><span ></span><c:out value="+"${sessionScope.consumidor.nome}"+"/>  </a><label>/</label></li>");
					}
      ...
      out.write("\t\t\t\t\t<div class=\"col-md-5 cup-in\">\n");
      out.write("\t\t\t\t\t\t<a href=\"#\"><img src=\"../images/p1.jpg\" class=\"img-responsive\" alt=\"\"></a>\n");
      out.write("\t\t\t\t\t\t<p>Produto 1</p>\n");
      out.write("\t\t\t\t\t\t<span class=\"dollar\">$25.89</span>\n");
      out.write("\t\t\t\t\t\t<div class=\"details-in\">\n");
      out.write("\t\t\t\t\t\t\t<a href=\"#\" class=\"details\">Detalhes</a>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div class=\"clearfix\"> </div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"col-md-5 cup-in\">\n");
      out.write("\t\t\t\t\t\t<a href=\"#\"><img src=\"../images/p2.jpg\" class=\"img-responsive\" alt=\"\"></a>\n");
      out.write("\t\t\t\t\t\t<p>Produto 2</p>\n");
      out.write("\t\t\t\t\t\t<span class=\"dollar\">$25.89</span>\n");
      out.write("\t\t\t\t\t\t<div class=\"details-in\">\n");
      out.write("\t\t\t\t\t\t\t<a href=\"#\" class=\"details\">Detalhes</a>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"col-md-5 cup-in\">\n");
      out.write("\t\t\t\t\t\t<a href=\"#\"><img src=\"../images/p3.jpg\" class=\"img-responsive\" alt=\"\"></a>\n");
      out.write("\t\t\t\t\t\t<p>Produto 3</p>\n");
      out.write("\t\t\t\t\t\t<span class=\"dollar\">$25.89</span>\n");
      out.write("\t\t\t\t\t\t<div class=\"details-in\">\n");
      out.write("\t\t\t\t\t\t\t<a href=\"#\" class=\"details\">Detalhes</a>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\t<div class=\"col-md-5 cup-in\">\n");
      out.write("\t\t\t\t\t\t<a href=\"#\"><img src=\"../images/p4.jpg\" class=\"img-responsive\" alt=\"\"></a>\n");
      out.write("\t\t\t\t\t\t<p>Produto 4</p>\n");
      out.write("\t\t\t\t\t\t<span class=\"dollar\">$25.89</span>\n");
      out.write("\t\t\t\t\t\t<div class=\"details-in\">\n");
      out.write("\t\t\t\t\t\t\t<a href=\"#\" class=\"details\">Detalhes</a>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t<p class=\"vit\">Procurar mais <span>...</span></p>\n");

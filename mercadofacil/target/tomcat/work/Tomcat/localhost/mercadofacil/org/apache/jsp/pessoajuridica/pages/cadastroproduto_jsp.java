 ...
 * Generated at: 2016-02-14 02:09:01 UTC
...
public final class cadastroproduto_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t</button>\n");
      out.write("\t\t\t\t<a class=\"navbar-brand\" href=\"paineladmin.jsp\">Mercado Fácil</a>\n");
      out.write("\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"Nenhum\">---Nenhum---</option>\n");
      ...
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group col-md-4\">\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"razaoSocialAnunciante\"> Razão Social\n");
      out.write("\t\t\t\t\t\t\t\t\tAnunciante </label> <input type=\"text\" class=\"form-control\"\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"razaoSocialAnunciante\">\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group col-md-6\">\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"nomeFantasiaSupermercado\"> Nome Fantasia do\n");
      out.write("\t\t\t\t\t\t\t\t\tSupermercado </label> <input type=\"text\" class=\"form-control\"\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"nomeFantasiaSupermercado\">\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group col-md-6\">\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"razaoSocialSupermercado\"> Razao Social do\n");
      out.write("\t\t\t\t\t\t\t\t\tSupermercado </label> <input type=\"text\" class=\"form-control\"\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"razaoSocialSupermercado\">\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tclass=\"btn btn-outline btn-primary btn-lg \"\n");

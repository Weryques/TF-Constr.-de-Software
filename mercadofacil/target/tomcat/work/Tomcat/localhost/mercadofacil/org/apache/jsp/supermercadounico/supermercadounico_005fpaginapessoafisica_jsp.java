 ...
 * Generated at: 2016-02-18 17:28:37 UTC
...
Consumidor consumidor = (Consumidor) session.getAttribute("consumidor");
      ...
      out.write("                                  <li>\n");
      out.write("                                      <button type=\"button\" class=\"btn btn-info\" onclick=\"mudarEstado('profile')\"><i class=\"icon-user\"></i>Perfil</button>\n");
      out.write("                                  </li>\n");
      out.write("                                  <li>\n");
      out.write("                                      <button type=\"button\" class=\"btn btn-info\" onclick=\"mudarEstado('edit-profile')\"><i class=\"icon-envelope\"></i>Editar Perfil</button>\n");
      out.write("                                  </li>\n");
      out.write("                              </ul>\n");
      out.write("                          </header>\n");
      out.write("                          \n");
      out.write("                          <div class=\"panel col-md-12 text-center\">\n");
      out.write("                             \n");
      out.write("                              <div class=\"tab-content pagination\">\n");
      out.write("                      \n");
      out.write("                              <!-- profile -->\n");
      out.write("                              <div id=\"profile\" class=\"tab-pane-active\" style=\"display: none;\">\n");
      out.write("                                    <section class=\"panel\">\n");
      out.write("                                      <div class=\"bio-graph-heading\">\n");
      out.write("                                                Sobre\n");
      out.write("                                      </div>\n");
      out.write("                                      <div class=\"panel-body bio-graph-info\">\n");
      out.write("                                          <h1>Dados do perfil</h1><br><br>\n");
      out.write("                                          <div class=\"row\">\n");
 ...
 out.print(consumidor.getTelefone()); 
      ...
      out.write("                                  <div id=\"edit-profile\" class=\"tab-pane\" style=\"display: none;\">\n");
      out.write("                                    <section class=\"panel\">  \n");
      out.write("                                    \n");
      ...
      out.write("                                                  \t<a onclick=\"popUpPergunta()\" class=\"btn btn-default\" role=\"button\">Excluir conta</a>\n");
      out.write("                                                  </div>\n");
      out.write("                                              </div>\n");
      out.write("                                          </div>\n");
      out.write("                                       </div>                                        \n");
      out.write("                                         \n");
      out.write("                                          <div class=\"panel-body bio-graph-info\">\n");
      out.write("                                              <h1>Infomações do perfil</h1><br><br>\n");
      ...
      out.write("\t\t\t\t    \n");
      out.write("\t\t\t\t\tif(display == \"none\" && id == \"profile\"){\n");
      out.write("\t\t\t\t        document.getElementById(id).style.display = 'block';\n");
      out.write("\t\t\t\t        document.getElementById(\"edit-profile\").style.display = 'none';\n");
      out.write("\t\t\t\t\t}\n");
      out.write("\t\t\t\t    else{\n");
      out.write("\t\t\t\t        document.getElementById(id).style.display = 'block';\n");
      ...
      out.write("\t\t\t\n");
      out.write("\t\t\t<script type=\"text/javascript\">\n");
      out.write("\t\t\t\tfunction popUpPergunta(){\n");
      out.write("\t\t\t\t\tvar VouF = confirm(\"Deseja continuar e excluir sua conta?\");\n");
      out.write("\t\t\t\t\tif(VouF){\n");
      out.write("\t\t\t\t\t\talert(\"Conta deletada!\");\n");
      out.write("\t\t\t\t\t\twindow.location.href = \"/mercadofacil/deletaconta?usuario=consumidor\";\n");
      out.write("\t\t\t\t\t}\n");
      out.write("\t\t\t\t\telse{\n");
      out.write("\t\t\t\t\t\talert(\":)\")\n");
      out.write("\t\t\t\t\t}\t\n");

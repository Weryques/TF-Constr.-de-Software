 ...
 * Generated at: 2016-02-17 17:43:08 UTC
...
Consumidor consumidor = (Consumidor) session.getAttribute("consumidor");
 ...
 out.print(consumidor.getNomeCompleto()); 
      ...
      out.write("\n");
      out.write("       \t\t\t \t<li><a href=\"carrinhocompras.jsp\" class=\"glyphicon glyphicon-shopping-cart\"><span ></span>Carrinho ");
      out.print(produtosAddCarrinho.size());
      out.write("  </a><label>/</label></li>\n");
      out.write("       \t\t\t \t\n");
      out.write("\t\t\t\t</ul>\n");
      out.write("\t\t\t\t<div class=\"clearfix\"> </div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tclass=\"img-responsive\" alt=\"\"></a>\n");
      out.write("\t\t\t\t\t\t\t\t<input name=\"nomeProduto\" <p><span class=\"dollar text-info\">");
      out.print(listaDeProdutos.get(i).getNome());
      out.write("</span></p> ><br>\n");
      out.write("\t\t\t\t\t\t\t\t<input name=\"valorProduto\" <span class=\"dollar col-md-5\">R$ ");
      out.print(listaDeProdutos.get(i).getValor());
      out.write("</span> >\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-outline btn-success glyphicon glyphicon-shopping-cart col-md-5\">Adicionar ao carrinho</button>\n");
      out.write("\t\t\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t");

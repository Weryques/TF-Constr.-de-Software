 ...
 * Generated at: 2016-02-18 04:37:21 UTC
...
Consumidor consumidor = (Consumidor) session.getAttribute("consumidor");
 ...
 out.print(consumidor.getNomeCompleto()); 
      ...
      out.write("\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t<li class=\"active\" ><a href=\"supermercadounico_home_logado.jsp\" >Home  </a><label>- </label> </li>\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t<!--script-->\n");
      out.write("\t\t\t\t<script>\n");
      ...
      out.write("\t\t\t\t\t\t\t                <fieldset>\n");
      out.write("\t\t\t\t\t\t\t                \t<a href=\"#\"> <img src=\"../images/p1.jpg\"> </a>\n");
      ...
      out.write("\t\t\t\t\t\t\t                    <input type=\"hidden\" name=\"currency_code\" value=\"BRL\" />\n");
      out.write("\t\t\t\t\t\t\t                    <input type=\"hidden\" name=\"return\" value=\"http://www.minicartjs.com/?success\" />\n");
      out.write("\t\t\t\t\t\t\t                    <input type=\"hidden\" name=\"cancel_return\" value=\"http://www.minicartjs.com/?cancel\" />\n");
      out.write("\t\t\t\t\t\t\t                    <strong>");
      out.print(listaDeProdutos.get(i).getNome());
      out.write("</strong>\n");
      out.write("\t\t\t\t\t\t\t                    <ul>\n");
      ...
      out.write("</li>\n");
      out.write("\t\t\t\t\t\t\t                    </ul>\n");
      out.write("\t\t\t\t\t\t\t                    <input class=\"btn btn-outline btn-success glyphicon glyphicon-shopping-cart\" type=\"submit\" name=\"submit\" value=\"Comprar\" class=\"button\" />\n");
      out.write("\t\t\t\t\t\t\t                </fieldset>\n");
      out.write("\t\t\t\t\t\t\t            </form>\n");
      out.write("\t\t\t\t\t\t\t            </div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\talert('A quantidade minima é 1. Por favor, adicione algo ao carrinho antes de finalizar a compra');\n");
